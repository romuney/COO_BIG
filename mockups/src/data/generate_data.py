...
summary = {
    ...
    "signals": [
        {"level": "red", "title": "Лимит численности HQ", "text": "Вилка прогноза 23 330–23 620 пересекает лимит. Нужно решение по ~300 вакансиям.", "page": "headcount", "owner": "HR HQ, финансы"},
