    ...
    return `<section class="spread" id="s1">
      ...
      <div class="hero">
        <div>
          ...
          <div class="hero-num">23 620 <span class="arrow">→</span></div>
          <p class="hero-say">Столько нас будет в декабре, если воронка найма закроется в срок. Разрешено 23 500.</p>
          <p class="hero-body">Сейчас в HQ 22 930 человек, до лимита остаётся 570. Но 412 принятых офферов и 1 850 вакансий в работе уже запущены: при обычной конверсии они дают 23 620. Уложиться можно, только если за сентябрь–декабрь нанять не больше 1 070 человек вместо 1 230 при нынешнем темпе. Это решение о приоритизации примерно трёхсот вакансий, и принять его нужно до того, как выйдут офферы.</p>
          <div class="hero-meter">${meter}</div>
        </div>
        <aside>
          <div class="clock">
          ...
          <div class="stakes">
            ...
            ${stakes}
            <p class="assump">${esc(K.items[0].assumption)}. Оценка порядка величины, не бюджет.</p>
          </div>
        </aside>
      </div>
